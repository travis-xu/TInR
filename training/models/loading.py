...
def load_tokenizer(model_name_or_path, cache_dir=None, virtual_tokens=False, virtual_tokens_file=None):
    ...
    if virtual_tokens:
        ...
        with open(virtual_tokens_file, 'r') as f:
...
def load_model(model_name_or_path, architecture, tokenizer=None, flash_attention=False, cache_dir=None, virtual_tokens=False, virtual_tokens_file=None):
