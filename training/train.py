...
class TrainingArguments(transformers.TrainingArguments):
    ...
    virtual_tokens_file: str = field(default="src/configs/virtual_tokens.txt")
    checkpoint_dir: str = field(default=None)



def train():
    # virtual_tokens_file="src/configs/virtual_tokens.txt"
    ...
    if args.checkpoint_dir is not None:
        state_dict = get_fp32_state_dict_from_zero_checkpoint(args.checkpoint_dir) # already on cpu
