...
from verl.utils.reward_score import gsm8k, math, multiply, countdown, rlla_call, rlla_token, rlla_token_param
...
def main(config):
    if not ray.is_initialized():
        ...
        ray.init(_temp_dir="/dev/shm/tmp/ray")
